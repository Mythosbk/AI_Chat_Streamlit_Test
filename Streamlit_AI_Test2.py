...
def ask_and_get_answer(vector_store, q, k=3): # the higher the k value the higher the
    # price because of the increase in tokens
...
if __name__ == "__main__":
    ...
    st.image('helpful_bot.png')
    st.subheader('AI Assisted Human Capital Team Prototype Document-Chat')
...
## Callbacks
## a function that gets called when the user interacts with a widget
## we use callbacks via on_change or on_click parameters of the widget
## on_change and on_click parameters accept a function name as an input argument.
